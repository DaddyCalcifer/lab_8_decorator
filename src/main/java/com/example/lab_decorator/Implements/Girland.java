...
public class Girland extends TreeDecorator {
    ...
    void drawWithGirland(Pane paneLight)
    {
        FadeTransition[] ft = new FadeTransition[9];

        circle[0] = new Circle(210,200,10, Color.RED);
        circle[1] = new Circle(270,200,10, Color.RED);
        circle[2] = new Circle(240,150,10, Color.YELLOW);
        circle[3] = new Circle(180,260,10, Color.BLUE);
        circle[4] = new Circle(240,260,10, Color.PURPLE);
        circle[5] = new Circle(300,260,10, Color.PURPLE);
        circle[6] = new Circle(145,340,10, Color.YELLOWGREEN);
        ...
        paneLight.getChildren().addAll(circle[0],circle[1],circle[2],
